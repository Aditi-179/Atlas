...
def train_model():
    ...
    features = [
        'HighBP', 'HighChol', 'BMI', 'DiffWalk', 'Age', 'Sex',
        'Smoker', 'PhysActivity', 'Veggies', 
        'HvyAlcoholConsump', 'Income', 'Education'
    ]
    target = 'Target_General_NCD'
    ...
    rf = RandomForestClassifier(
        ...
        class_weight="balanced", # CRITICAL: Tells the model that missing a sick person is a big mistake
